                ...
                <div>
                    ...
                    <div>
                        ...
                        <div className='flex flex-col items-center mt-2 -mx-2'>
                            <Link to='/'>
                                <img
                                    className='object-cover border border-3 border-teal-700 w-16 h-16 mx-2 rounded-full'
                    ...
                    >
                        ...
                        <span className='mx-4 font-medium'>Man</span>
                    </NavLink>
                    <NavLink
                        to='/portfolio'
                        onClick={closeSidebar}
                    ...
                    >
                        ...
                        <span className='mx-4 font-medium'>Woman</span>
                    </NavLink>
                    <NavLink
                        to='/Contract'
                        onClick={closeSidebar}
                    ...
                    >
                        ...
                        <span className='mx-4 font-medium'>Kids</span>
                    </NavLink>
                </div>
